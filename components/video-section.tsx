  ...
  return (
    <AnimatedSection className="py-24 sm:py-28">
      <div className="section-shell">
        <div className="overflow-hidden rounded-[36px] border border-white/10 bg-white/10 p-5 shadow-glow md:p-8">
          <div className="mb-8 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            />
            <div className="inline-flex items-center gap-3 rounded-full border border-gold/20 bg-gold/10 px-5 py-3 text-sm text-white/80">
